...
#endif
/*-----------------------------------------------
 * read and get the inputs
 *-----------------------------------------------*/

/*-----------------------------------------------*/
/* Local function to get the inputs */
/*---------------header file---------------*/
...
/*--------------------------------choices based on our requirments--------------------------------------*/
